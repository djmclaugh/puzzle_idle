...
//
// export class PositionsMustBeSeenProcess extends Process<void> {
...
//     this.friendlyName = `${ordinal(position + 1)} cell seen for sure - ${faceToString(face)} Face - ${listName} ${rowIndex + 1}`;
//     this.interfaceId = interfaceId;
//     this.processId = `position_must_be_seen_for_sure_${position}_${faceToString(face).toLowerCase()}_${rowIndex}_${interfaceId}`;
//   }
//
